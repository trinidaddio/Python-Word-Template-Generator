...
# Uses pre-defined hardcoded prompts for company-specific content generation and optimization of output. 
# GUI prompt controls are constrained to drop downs and high-level descriptive text for content. 
...
# --- MODIFICATION END ---
    ...
    """
    try:
        # IMPORTANT: Replace with your actual API key retrieval method (e.g., environment variable)
...
def _replace_placeholder_in_range(doc_range, placeholder, replacement_text):
    ...
    find.Replacement.Text = str(replacement_text) # Ensure replacement is a string
    find.Forward = True
    ...
    try:
        ...
        for i, row in df.iterrows():
            ...
            try:
                ...
                for col_header in df.columns:
                    ...
                    if heading_pattern.match(col_header):
                        ...
                        if heading_content:
                            ...
                            word.Selection.TypeParagraph() # Add a paragraph break after the heading
                ...
                # --- Cleanup and Header/Footer Replacements ---
                ...
                if doc.Sections.Count > 0:
                    ...
                    # --- Replace all placeholders from Excel row ---
...
class DocCreatorApp(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        audience_options = [
            ...
            "Hospital Administrators", "Regulatory Auditors", 
            "Internal Engineers (R&D, Manufacturing)", "Sales & Marketing Teams"
        ]
        tone_options = [
            "Professional", "Pragmatic and Authoritative","Technical", "Instructional", 
    ...
    def reset_ui(self, finished=False):
        ...
        if finished:
            ...
            self.status_label.configure(text=f"Status: Finished. {self.progress_bar.get()*100:.0f}% Complete")

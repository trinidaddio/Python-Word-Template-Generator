...
Tables_vtables_ = [
	...
	(( 'Item' , 'Index' , 'prop' , ), 0, (0, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{00020951-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 0 , 96 , (3, 0, None, None) , 0 , )),
	(( 'AddOld' , 'Range' , 'NumRows' , 'NumColumns' , 'prop' , 
			 ), 4, (4, (), [ (9, 1, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , (3, 1, None, None) , (3, 1, None, None) , (16393, 10, None, "IID('{00020951-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 0 , 104 , (3, 0, None, None) , 64 , )),
	(( 'Add' , 'Range' , 'NumRows' , 'NumColumns' , 'DefaultTableBehavior' , 
			 ...
			 (3, 1, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16393, 10, None, "IID('{00020951-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 2 , 112 , (3, 0, None, None) , 0 , )),
	(( 'NestingLevel' , 'prop' , ), 100, (100, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 120 , (3, 0, None, None) , 0 , )),
]

...
class HeadersFooters(DispatchBaseClass):
	CLSID = IID('{00020984-0000-0000-C000-000000000046}')
	coclass_clsid = None

	# Result is of type HeaderFooter
	def Item(self, Index=defaultNamedNotOptArg):
		ret = self._oleobj_.InvokeTypes(0, LCID, 1, (9, 0), ((3, 1),),Index
			)
		if ret is not None:
			ret = Dispatch(ret, 'Item', '{00020985-0000-0000-C000-000000000046}')
		return ret
	...
	def __call__(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, '__call__', '{00020985-0000-0000-C000-000000000046}')
		return ret
	...
	def __iter__(self):
		...
		return win32com.client.util.Iterator(ob, '{00020985-0000-0000-C000-000000000046}')
...
win32com.client.CLSIDToClass.RegisterCLSID( "{00020984-0000-0000-C000-000000000046}", HeadersFooters )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 3.13.3 (tags/v3.13.3:6280bb5, Apr  8 2025, 14:47:33) [MSC v.1943 64 bit (AMD64)]
# From type library '{00020905-0000-0000-C000-000000000046}'
...
HeadersFooters_vtables_ = [
	...
	(( 'Item' , 'Index' , 'prop' , ), 0, (0, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{00020985-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 0 , 96 , (3, 0, None, None) , 0 , )),
]

...
class constants:
	...
	wdClassicBlue                 =18         # from enum WdColorIndex
	wdClassicRed                  =17         # from enum WdColorIndex
	...
	wdAllowHyphenationAtTrackBottom=71         # from enum WdCompatibility
	...
	wdDelayableFloatingTable      =70         # from enum WdCompatibility
	...
	wdUsePre2018iOSMacLayout      =73         # from enum WdCompatibility
	...
	wdUseWord2013TrackBottomHyphenation=72         # from enum WdCompatibility
	...
	wdInlineShape3DModel          =19         # from enum WdInlineShapeType
	...
	wdInlineShapeGraphic          =17         # from enum WdInlineShapeType
	wdInlineShapeHorizontalLine   =6          # from enum WdInlineShapeType
	wdInlineShapeLinked3DModel    =20         # from enum WdInlineShapeType
	wdInlineShapeLinkedGraphic    =18         # from enum WdInlineShapeType
	...
	wdSideToSide                  =2          # from enum WdPageMovementType
	wdVertical                    =1          # from enum WdPageMovementType
	...
	wdRDIAtMentions               =18         # from enum WdRemoveDocInfoType
	wdRDICommentReactions         =21         # from enum WdRemoveDocInfoType
	wdRDIComments                 =1          # from enum WdRemoveDocInfoType
	wdRDIContentType              =16         # from enum WdRemoveDocInfoType
	wdRDIDocumentIntelligence     =20         # from enum WdRemoveDocInfoType
	...
	wdRDIDocumentTasks            =19         # from enum WdRemoveDocInfoType
...
CLSIDToPackageMap = {
	...
	'{00020909-0000-0000-C000-000000000046}' : 'Model3DFormat',
}
VTablesToClassMap = {}
VTablesToPackageMap = {
	'{00020970-0000-0000-C000-000000000046}' : '_Application',
...
NamesToIIDMap = {
	...
	'Model3DFormat' : '{00020909-0000-0000-C000-000000000046}',
}

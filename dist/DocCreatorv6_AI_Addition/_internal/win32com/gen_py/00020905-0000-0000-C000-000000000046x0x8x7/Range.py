...
class Range(DispatchBaseClass):
	...
	def ExportAsFixedFormat2(self, OutputFileName=defaultNamedNotOptArg, ExportFormat=defaultNamedNotOptArg, OpenAfterExport=False, OptimizeFor=0
		...
		return self._oleobj_.InvokeTypes(509, LCID, 1, (24, 0), ((8, 1), (3, 1), (11, 49), (3, 49), (11, 49), (3, 49), (11, 49), (11, 49), (3, 49), (11, 49), (11, 49), (11, 49), (11, 49), (16396, 17)),OutputFileName
			, ExportFormat, OpenAfterExport, OptimizeFor, ExportCurrentPage, Item
			, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts
	...
	def ExportAsFixedFormat3(self, OutputFileName=defaultNamedNotOptArg, ExportFormat=defaultNamedNotOptArg, OpenAfterExport=False, OptimizeFor=0
		...
		return self._oleobj_.InvokeTypes(510, LCID, 1, (24, 0), ((8, 1), (3, 1), (11, 49), (3, 49), (11, 49), (3, 49), (11, 49), (11, 49), (3, 49), (11, 49), (11, 49), (11, 49), (11, 49), (11, 49), (16396, 17)),OutputFileName
			, ExportFormat, OpenAfterExport, OptimizeFor, ExportCurrentPage, Item
			, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts
	...
	def SortByHeadings(self, SortFieldType=defaultNamedOptArg, SortOrder=defaultNamedOptArg, CaseSensitive=defaultNamedOptArg, BidiSort=defaultNamedOptArg
			, IgnoreThe=defaultNamedOptArg, IgnoreKashida=defaultNamedOptArg, IgnoreDiacritics=defaultNamedOptArg, IgnoreHe=defaultNamedOptArg, LanguageID=defaultNamedOptArg):
		return self._oleobj_.InvokeTypes(508, LCID, 1, (24, 0), ((16396, 17), (16396, 17), (16396, 17), (16396, 17), (16396, 17), (16396, 17), (16396, 17), (16396, 17), (16396, 17)),SortFieldType
	...
	_prop_map_get_ = {
		...
		"TextVisibleOnScreen": (507, 2, (3, 0), (), "TextVisibleOnScreen", None),
...
Range_vtables_ = [
	...
	(( 'Duplicate' , 'prop' , ), 6, (6, (), [ (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 136 , (3, 0, None, None) , 0 , )),
	(( 'StoryType' , 'prop' , ), 7, (7, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 144 , (3, 0, None, None) , 0 , )),
	(( 'Tables' , 'prop' , ), 50, (50, (), [ (16393, 10, None, "IID('{0002094D-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 152 , (3, 0, None, None) , 0 , )),
	(( 'Words' , 'prop' , ), 51, (51, (), [ (16393, 10, None, "IID('{0002095C-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 160 , (3, 0, None, None) , 0 , )),
	(( 'Sentences' , 'prop' , ), 52, (52, (), [ (16393, 10, None, "IID('{0002095B-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 168 , (3, 0, None, None) , 0 , )),
	(( 'Characters' , 'prop' , ), 53, (53, (), [ (16393, 10, None, "IID('{0002095D-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 176 , (3, 0, None, None) , 0 , )),
	(( 'Footnotes' , 'prop' , ), 54, (54, (), [ (16393, 10, None, "IID('{00020942-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 184 , (3, 0, None, None) , 0 , )),
	(( 'Endnotes' , 'prop' , ), 55, (55, (), [ (16393, 10, None, "IID('{00020941-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 192 , (3, 0, None, None) , 0 , )),
	(( 'Comments' , 'prop' , ), 56, (56, (), [ (16393, 10, None, "IID('{00020940-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 200 , (3, 0, None, None) , 0 , )),
	(( 'Cells' , 'prop' , ), 57, (57, (), [ (16393, 10, None, "IID('{0002094A-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 208 , (3, 0, None, None) , 0 , )),
	(( 'Sections' , 'prop' , ), 58, (58, (), [ (16393, 10, None, "IID('{0002095A-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 216 , (3, 0, None, None) , 0 , )),
	(( 'Paragraphs' , 'prop' , ), 59, (59, (), [ (16393, 10, None, "IID('{00020958-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 224 , (3, 0, None, None) , 0 , )),
	(( 'Borders' , 'prop' , ), 1100, (1100, (), [ (16393, 10, None, "IID('{0002093C-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 232 , (3, 0, None, None) , 0 , )),
	(( 'Borders' , 'prop' , ), 1100, (1100, (), [ (9, 1, None, "IID('{0002093C-0000-0000-C000-000000000046}')") , ], 1 , 4 , 4 , 0 , 240 , (3, 0, None, None) , 0 , )),
	(( 'Shading' , 'prop' , ), 61, (61, (), [ (16393, 10, None, "IID('{0002093A-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 248 , (3, 0, None, None) , 0 , )),
	(( 'TextRetrievalMode' , 'prop' , ), 62, (62, (), [ (16393, 10, None, "IID('{00020939-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 256 , (3, 0, None, None) , 0 , )),
	(( 'TextRetrievalMode' , 'prop' , ), 62, (62, (), [ (9, 1, None, "IID('{00020939-0000-0000-C000-000000000046}')") , ], 1 , 4 , 4 , 0 , 264 , (3, 0, None, None) , 0 , )),
	...
	(( 'ListFormat' , 'prop' , ), 68, (68, (), [ (16393, 10, None, "IID('{000209C0-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 312 , (3, 0, None, None) , 0 , )),
	(( 'Bookmarks' , 'prop' , ), 75, (75, (), [ (16393, 10, None, "IID('{00020967-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 320 , (3, 0, None, None) , 0 , )),
	(( 'Application' , 'prop' , ), 1000, (1000, (), [ (16397, 10, None, "IID('{000209FF-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 328 , (3, 0, None, None) , 0 , )),
	(( 'Creator' , 'prop' , ), 1001, (1001, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 336 , (3, 0, None, None) , 0 , )),
	(( 'Parent' , 'prop' , ), 1002, (1002, (), [ (16393, 10, None, None) , ], 1 , 2 , 4 , 0 , 344 , (3, 0, None, None) , 0 , )),
	(( 'Bold' , 'prop' , ), 130, (130, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 352 , (3, 0, None, None) , 0 , )),
	(( 'Bold' , 'prop' , ), 130, (130, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 360 , (3, 0, None, None) , 0 , )),
	(( 'Italic' , 'prop' , ), 131, (131, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 368 , (3, 0, None, None) , 0 , )),
	(( 'Italic' , 'prop' , ), 131, (131, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 376 , (3, 0, None, None) , 0 , )),
	(( 'Underline' , 'prop' , ), 139, (139, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 384 , (3, 0, None, None) , 0 , )),
	(( 'Underline' , 'prop' , ), 139, (139, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 392 , (3, 0, None, None) , 0 , )),
	(( 'EmphasisMark' , 'prop' , ), 140, (140, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 400 , (3, 0, None, None) , 0 , )),
	(( 'EmphasisMark' , 'prop' , ), 140, (140, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 408 , (3, 0, None, None) , 0 , )),
	(( 'DisableCharacterSpaceGrid' , 'prop' , ), 141, (141, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 416 , (3, 0, None, None) , 0 , )),
	(( 'DisableCharacterSpaceGrid' , 'prop' , ), 141, (141, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 424 , (3, 0, None, None) , 0 , )),
	(( 'Revisions' , 'prop' , ), 150, (150, (), [ (16393, 10, None, "IID('{00020980-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 432 , (3, 0, None, None) , 0 , )),
	(( 'Style' , 'prop' , ), 151, (151, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 440 , (3, 0, None, None) , 0 , )),
	(( 'Style' , 'prop' , ), 151, (151, (), [ (16396, 1, None, None) , ], 1 , 4 , 4 , 0 , 448 , (3, 0, None, None) , 0 , )),
	(( 'StoryLength' , 'prop' , ), 152, (152, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 456 , (3, 0, None, None) , 0 , )),
	(( 'LanguageID' , 'prop' , ), 153, (153, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 464 , (3, 0, None, None) , 0 , )),
	(( 'LanguageID' , 'prop' , ), 153, (153, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 472 , (3, 0, None, None) , 0 , )),
	(( 'SynonymInfo' , 'prop' , ), 155, (155, (), [ (16393, 10, None, "IID('{0002099B-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 480 , (3, 0, None, None) , 0 , )),
	(( 'Hyperlinks' , 'prop' , ), 156, (156, (), [ (16393, 10, None, "IID('{0002099C-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 488 , (3, 0, None, None) , 0 , )),
	(( 'ListParagraphs' , 'prop' , ), 157, (157, (), [ (16393, 10, None, "IID('{00020991-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 496 , (3, 0, None, None) , 0 , )),
	(( 'Subdocuments' , 'prop' , ), 159, (159, (), [ (16393, 10, None, "IID('{00020988-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 504 , (3, 0, None, None) , 0 , )),
	(( 'GrammarChecked' , 'prop' , ), 260, (260, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 512 , (3, 0, None, None) , 0 , )),
	(( 'GrammarChecked' , 'prop' , ), 260, (260, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 520 , (3, 0, None, None) , 0 , )),
	(( 'SpellingChecked' , 'prop' , ), 261, (261, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 528 , (3, 0, None, None) , 0 , )),
	(( 'SpellingChecked' , 'prop' , ), 261, (261, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 536 , (3, 0, None, None) , 0 , )),
	(( 'HighlightColorIndex' , 'prop' , ), 301, (301, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 544 , (3, 0, None, None) , 0 , )),
	(( 'HighlightColorIndex' , 'prop' , ), 301, (301, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 552 , (3, 0, None, None) , 0 , )),
	(( 'Columns' , 'prop' , ), 302, (302, (), [ (16393, 10, None, "IID('{0002094B-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 560 , (3, 0, None, None) , 0 , )),
	(( 'Rows' , 'prop' , ), 303, (303, (), [ (16393, 10, None, "IID('{0002094C-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 568 , (3, 0, None, None) , 0 , )),
	(( 'CanEdit' , 'prop' , ), 304, (304, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 576 , (3, 0, None, None) , 64 , )),
	(( 'CanPaste' , 'prop' , ), 305, (305, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 584 , (3, 0, None, None) , 64 , )),
	(( 'IsEndOfRowMark' , 'prop' , ), 307, (307, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 592 , (3, 0, None, None) , 0 , )),
	(( 'BookmarkID' , 'prop' , ), 308, (308, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 600 , (3, 0, None, None) , 0 , )),
	(( 'PreviousBookmarkID' , 'prop' , ), 309, (309, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 608 , (3, 0, None, None) , 0 , )),
	(( 'Find' , 'prop' , ), 262, (262, (), [ (16393, 10, None, "IID('{000209B0-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 616 , (3, 0, None, None) , 0 , )),
	(( 'PageSetup' , 'prop' , ), 1101, (1101, (), [ (16393, 10, None, "IID('{00020971-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 624 , (3, 0, None, None) , 0 , )),
	(( 'PageSetup' , 'prop' , ), 1101, (1101, (), [ (9, 1, None, "IID('{00020971-0000-0000-C000-000000000046}')") , ], 1 , 4 , 4 , 0 , 632 , (3, 0, None, None) , 0 , )),
	(( 'ShapeRange' , 'prop' , ), 311, (311, (), [ (16393, 10, None, "IID('{000209B5-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 640 , (3, 0, None, None) , 0 , )),
	(( 'Case' , 'prop' , ), 312, (312, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 648 , (3, 0, None, None) , 0 , )),
	(( 'Case' , 'prop' , ), 312, (312, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 656 , (3, 0, None, None) , 0 , )),
	(( 'Information' , 'Type' , 'prop' , ), 313, (313, (), [ (3, 1, None, None) , 
			 (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 664 , (3, 0, None, None) , 0 , )),
	(( 'ReadabilityStatistics' , 'prop' , ), 314, (314, (), [ (16393, 10, None, "IID('{000209AE-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 672 , (3, 0, None, None) , 0 , )),
	(( 'GrammaticalErrors' , 'prop' , ), 315, (315, (), [ (16393, 10, None, "IID('{000209BB-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 680 , (3, 0, None, None) , 0 , )),
	(( 'SpellingErrors' , 'prop' , ), 316, (316, (), [ (16393, 10, None, "IID('{000209BB-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 688 , (3, 0, None, None) , 0 , )),
	(( 'Orientation' , 'prop' , ), 317, (317, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 696 , (3, 0, None, None) , 0 , )),
	(( 'Orientation' , 'prop' , ), 317, (317, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 704 , (3, 0, None, None) , 0 , )),
	(( 'InlineShapes' , 'prop' , ), 319, (319, (), [ (16393, 10, None, "IID('{000209A9-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 712 , (3, 0, None, None) , 0 , )),
	(( 'NextStoryRange' , 'prop' , ), 320, (320, (), [ (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 720 , (3, 0, None, None) , 0 , )),
	(( 'LanguageIDFarEast' , 'prop' , ), 321, (321, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 728 , (3, 0, None, None) , 0 , )),
	(( 'LanguageIDFarEast' , 'prop' , ), 321, (321, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 736 , (3, 0, None, None) , 0 , )),
	(( 'LanguageIDOther' , 'prop' , ), 322, (322, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 744 , (3, 0, None, None) , 0 , )),
	(( 'LanguageIDOther' , 'prop' , ), 322, (322, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 752 , (3, 0, None, None) , 0 , )),
	(( 'Select' , ), 65535, (65535, (), [ ], 1 , 1 , 4 , 0 , 760 , (3, 0, None, None) , 0 , )),
	(( 'SetRange' , 'Start' , 'End' , ), 100, (100, (), [ (3, 1, None, None) , 
			 (3, 1, None, None) , ], 1 , 1 , 4 , 0 , 768 , (3, 0, None, None) , 0 , )),
	(( 'Collapse' , 'Direction' , ), 101, (101, (), [ (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 776 , (3, 0, None, None) , 0 , )),
	(( 'InsertBefore' , 'Text' , ), 102, (102, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 784 , (3, 0, None, None) , 0 , )),
	(( 'InsertAfter' , 'Text' , ), 104, (104, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 792 , (3, 0, None, None) , 0 , )),
	(( 'Next' , 'Unit' , 'Count' , 'prop' , ), 105, (105, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 2 , 800 , (3, 0, None, None) , 0 , )),
	(( 'Previous' , 'Unit' , 'Count' , 'prop' , ), 106, (106, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 2 , 808 , (3, 0, None, None) , 0 , )),
	...
	(( 'EndOf' , 'Unit' , 'Extend' , 'prop' , ), 108, (108, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 2 , 824 , (3, 0, None, None) , 0 , )),
	(( 'Move' , 'Unit' , 'Count' , 'prop' , ), 109, (109, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 2 , 832 , (3, 0, None, None) , 0 , )),
	(( 'MoveStart' , 'Unit' , 'Count' , 'prop' , ), 110, (110, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 2 , 840 , (3, 0, None, None) , 0 , )),
	(( 'MoveEnd' , 'Unit' , 'Count' , 'prop' , ), 111, (111, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 2 , 848 , (3, 0, None, None) , 0 , )),
	(( 'MoveWhile' , 'Cset' , 'Count' , 'prop' , ), 112, (112, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 856 , (3, 0, None, None) , 0 , )),
	(( 'MoveStartWhile' , 'Cset' , 'Count' , 'prop' , ), 113, (113, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 864 , (3, 0, None, None) , 0 , )),
	(( 'MoveEndWhile' , 'Cset' , 'Count' , 'prop' , ), 114, (114, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 872 , (3, 0, None, None) , 0 , )),
	(( 'MoveUntil' , 'Cset' , 'Count' , 'prop' , ), 115, (115, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 880 , (3, 0, None, None) , 0 , )),
	(( 'MoveStartUntil' , 'Cset' , 'Count' , 'prop' , ), 116, (116, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 888 , (3, 0, None, None) , 0 , )),
	(( 'MoveEndUntil' , 'Cset' , 'Count' , 'prop' , ), 117, (117, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 896 , (3, 0, None, None) , 0 , )),
	(( 'Cut' , ), 119, (119, (), [ ], 1 , 1 , 4 , 0 , 904 , (3, 0, None, None) , 0 , )),
	(( 'Copy' , ), 120, (120, (), [ ], 1 , 1 , 4 , 0 , 912 , (3, 0, None, None) , 0 , )),
	(( 'Paste' , ), 121, (121, (), [ ], 1 , 1 , 4 , 0 , 920 , (3, 0, None, None) , 0 , )),
	(( 'InsertBreak' , 'Type' , ), 122, (122, (), [ (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 928 , (3, 0, None, None) , 0 , )),
	(( 'InsertFile' , 'FileName' , 'Range' , 'ConfirmConversions' , 'Link' , 
			 'Attachment' , ), 123, (123, (), [ (8, 1, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 4 , 936 , (3, 0, None, None) , 0 , )),
	(( 'InStory' , 'Range' , 'prop' , ), 125, (125, (), [ (9, 1, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , 
			 (16395, 10, None, None) , ], 1 , 1 , 4 , 0 , 944 , (3, 0, None, None) , 0 , )),
	(( 'InRange' , 'Range' , 'prop' , ), 126, (126, (), [ (9, 1, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , 
			 (16395, 10, None, None) , ], 1 , 1 , 4 , 0 , 952 , (3, 0, None, None) , 0 , )),
	(( 'Delete' , 'Unit' , 'Count' , 'prop' , ), 127, (127, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16387, 10, None, None) , ], 1 , 1 , 4 , 2 , 960 , (3, 0, None, None) , 0 , )),
	(( 'WholeStory' , ), 128, (128, (), [ ], 1 , 1 , 4 , 0 , 968 , (3, 0, None, None) , 0 , )),
	(( 'Expand' , 'Unit' , 'prop' , ), 129, (129, (), [ (16396, 17, None, None) , 
			 (16387, 10, None, None) , ], 1 , 1 , 4 , 1 , 976 , (3, 0, None, None) , 0 , )),
	(( 'InsertParagraph' , ), 160, (160, (), [ ], 1 , 1 , 4 , 0 , 984 , (3, 0, None, None) , 0 , )),
	(( 'InsertParagraphAfter' , ), 161, (161, (), [ ], 1 , 1 , 4 , 0 , 992 , (3, 0, None, None) , 0 , )),
	(( 'ConvertToTableOld' , 'Separator' , 'NumRows' , 'NumColumns' , 'InitialColumnWidth' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16393, 10, None, "IID('{00020951-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 14 , 1000 , (3, 0, None, None) , 64 , )),
	(( 'InsertDateTimeOld' , 'DateTimeFormat' , 'InsertAsField' , 'InsertAsFullWidth' , ), 163, (163, (), [ 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 3 , 1008 , (3, 0, None, None) , 64 , )),
	(( 'InsertSymbol' , 'CharacterNumber' , 'Font' , 'Unicode' , 'Bias' , 
			 ), 164, (164, (), [ (3, 1, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 3 , 1016 , (3, 0, None, None) , 0 , )),
	(( 'InsertCrossReference_2002' , 'ReferenceType' , 'ReferenceKind' , 'ReferenceItem' , 'InsertAsHyperlink' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 2 , 1024 , (3, 0, None, None) , 64 , )),
	(( 'InsertCaptionXP' , 'Label' , 'Title' , 'TitleAutoText' , 'Position' , 
			 ), 166, (166, (), [ (16396, 1, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 3 , 1032 , (3, 0, None, None) , 64 , )),
	(( 'CopyAsPicture' , ), 167, (167, (), [ ], 1 , 1 , 4 , 0 , 1040 , (3, 0, None, None) , 0 , )),
	(( 'SortOld' , 'ExcludeHeader' , 'FieldNumber' , 'SortFieldType' , 'SortOrder' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 14 , 1048 , (3, 0, None, None) , 64 , )),
	(( 'SortAscending' , ), 169, (169, (), [ ], 1 , 1 , 4 , 0 , 1056 , (3, 0, None, None) , 0 , )),
	(( 'SortDescending' , ), 170, (170, (), [ ], 1 , 1 , 4 , 0 , 1064 , (3, 0, None, None) , 0 , )),
	(( 'IsEqual' , 'Range' , 'prop' , ), 171, (171, (), [ (9, 1, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , 
			 (16395, 10, None, None) , ], 1 , 1 , 4 , 0 , 1072 , (3, 0, None, None) , 0 , )),
	(( 'Calculate' , 'prop' , ), 172, (172, (), [ (16388, 10, None, None) , ], 1 , 1 , 4 , 0 , 1080 , (3, 0, None, None) , 0 , )),
	(( 'GoTo' , 'What' , 'Which' , 'Count' , 'Name' , 
			 'prop' , ), 173, (173, (), [ (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 4 , 1088 , (3, 0, None, None) , 0 , )),
	(( 'GoToNext' , 'What' , 'prop' , ), 174, (174, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 0 , 1096 , (3, 0, None, None) , 0 , )),
	(( 'GoToPrevious' , 'What' , 'prop' , ), 175, (175, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 0 , 1104 , (3, 0, None, None) , 0 , )),
	(( 'PasteSpecial' , 'IconIndex' , 'Link' , 'Placement' , 'DisplayAsIcon' , 
			 'DataType' , 'IconFileName' , 'IconLabel' , ), 176, (176, (), [ (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , ], 1 , 1 , 4 , 7 , 1112 , (3, 0, None, None) , 0 , )),
	(( 'LookupNameProperties' , ), 177, (177, (), [ ], 1 , 1 , 4 , 0 , 1120 , (3, 0, None, None) , 0 , )),
	(( 'ComputeStatistics' , 'Statistic' , 'prop' , ), 178, (178, (), [ (3, 1, None, None) , 
			 (16387, 10, None, None) , ], 1 , 1 , 4 , 0 , 1128 , (3, 0, None, None) , 0 , )),
	(( 'Relocate' , 'Direction' , ), 179, (179, (), [ (3, 1, None, None) , ], 1 , 1 , 4 , 0 , 1136 , (3, 0, None, None) , 0 , )),
	(( 'CheckSynonyms' , ), 180, (180, (), [ ], 1 , 1 , 4 , 0 , 1144 , (3, 0, None, None) , 0 , )),
	(( 'SubscribeTo' , 'Edition' , 'Format' , ), 181, (181, (), [ (8, 1, None, None) , 
			 (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 1152 , (3, 0, None, None) , 64 , )),
	(( 'CreatePublisher' , 'Edition' , 'ContainsPICT' , 'ContainsRTF' , 'ContainsText' , 
			 ), 182, (182, (), [ (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 4 , 1160 , (3, 0, None, None) , 64 , )),
	(( 'InsertAutoText' , ), 183, (183, (), [ ], 1 , 1 , 4 , 0 , 1168 , (3, 0, None, None) , 0 , )),
	(( 'InsertDatabase' , 'Format' , 'Style' , 'LinkToSource' , 'Connection' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 14 , 1176 , (3, 0, None, None) , 0 , )),
	(( 'AutoFormat' , ), 195, (195, (), [ ], 1 , 1 , 4 , 0 , 1184 , (3, 0, None, None) , 0 , )),
	(( 'CheckGrammar' , ), 204, (204, (), [ ], 1 , 1 , 4 , 0 , 1192 , (3, 0, None, None) , 0 , )),
	(( 'CheckSpelling' , 'CustomDictionary' , 'IgnoreUppercase' , 'AlwaysSuggest' , 'CustomDictionary2' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , ], 1 , 1 , 4 , 12 , 1200 , (3, 0, None, None) , 0 , )),
	(( 'GetSpellingSuggestions' , 'CustomDictionary' , 'IgnoreUppercase' , 'MainDictionary' , 'SuggestionMode' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16393, 10, None, "IID('{000209AA-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 13 , 1208 , (3, 0, None, None) , 0 , )),
	(( 'InsertParagraphBefore' , ), 212, (212, (), [ ], 1 , 1 , 4 , 0 , 1216 , (3, 0, None, None) , 0 , )),
	(( 'NextSubdocument' , ), 219, (219, (), [ ], 1 , 1 , 4 , 0 , 1224 , (3, 0, None, None) , 0 , )),
	(( 'PreviousSubdocument' , ), 220, (220, (), [ ], 1 , 1 , 4 , 0 , 1232 , (3, 0, None, None) , 0 , )),
	(( 'ConvertHangulAndHanja' , 'ConversionsMode' , 'FastConversion' , 'CheckHangulEnding' , 'EnableRecentOrdering' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 5 , 1240 , (3, 0, None, None) , 0 , )),
	(( 'PasteAsNestedTable' , ), 222, (222, (), [ ], 1 , 1 , 4 , 0 , 1248 , (3, 0, None, None) , 0 , )),
	(( 'ModifyEnclosure' , 'Style' , 'Symbol' , 'EnclosedText' , ), 223, (223, (), [ 
			 (16396, 1, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 2 , 1256 , (3, 0, None, None) , 0 , )),
	(( 'PhoneticGuide' , 'Text' , 'Alignment' , 'Raise' , 'FontSize' , 
			 'FontName' , ), 224, (224, (), [ (8, 1, None, None) , (3, 49, '-1', None) , (3, 49, '0', None) , 
			 (3, 49, '0', None) , (8, 49, "''", None) , ], 1 , 1 , 4 , 0 , 1264 , (3, 32, None, None) , 0 , )),
	(( 'InsertDateTime' , 'DateTimeFormat' , 'InsertAsField' , 'InsertAsFullWidth' , 'DateLanguage' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 5 , 1272 , (3, 0, None, None) , 0 , )),
	(( 'Sort' , 'ExcludeHeader' , 'FieldNumber' , 'SortFieldType' , 'SortOrder' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 19 , 1280 , (3, 0, None, None) , 0 , )),
	(( 'DetectLanguage' , ), 203, (203, (), [ ], 1 , 1 , 4 , 0 , 1288 , (3, 0, None, None) , 0 , )),
	(( 'ConvertToTable' , 'Separator' , 'NumRows' , 'NumColumns' , 'InitialColumnWidth' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16393, 10, None, "IID('{00020951-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 16 , 1296 , (3, 0, None, None) , 0 , )),
	(( 'TCSCConverter' , 'WdTCSCConverterDirection' , 'CommonTerms' , 'UseVariants' , ), 499, (499, (), [ 
			 (3, 49, '2', None) , (11, 49, 'False', None) , (11, 49, 'False', None) , ], 1 , 1 , 4 , 0 , 1304 , (3, 0, None, None) , 0 , )),
	(( 'LanguageDetected' , 'prop' , ), 263, (263, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 1312 , (3, 0, None, None) , 0 , )),
	(( 'LanguageDetected' , 'prop' , ), 263, (263, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 1320 , (3, 0, None, None) , 0 , )),
	(( 'FitTextWidth' , 'prop' , ), 264, (264, (), [ (16388, 10, None, None) , ], 1 , 2 , 4 , 0 , 1328 , (3, 0, None, None) , 0 , )),
	(( 'FitTextWidth' , 'prop' , ), 264, (264, (), [ (4, 1, None, None) , ], 1 , 4 , 4 , 0 , 1336 , (3, 0, None, None) , 0 , )),
	(( 'HorizontalInVertical' , 'prop' , ), 265, (265, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1344 , (3, 0, None, None) , 0 , )),
	(( 'HorizontalInVertical' , 'prop' , ), 265, (265, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1352 , (3, 0, None, None) , 0 , )),
	(( 'TwoLinesInOne' , 'prop' , ), 266, (266, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1360 , (3, 0, None, None) , 0 , )),
	(( 'TwoLinesInOne' , 'prop' , ), 266, (266, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1368 , (3, 0, None, None) , 0 , )),
	(( 'CombineCharacters' , 'prop' , ), 267, (267, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 1376 , (3, 0, None, None) , 0 , )),
	(( 'CombineCharacters' , 'prop' , ), 267, (267, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 1384 , (3, 0, None, None) , 0 , )),
	(( 'NoProofing' , 'prop' , ), 323, (323, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1392 , (3, 0, None, None) , 0 , )),
	(( 'NoProofing' , 'prop' , ), 323, (323, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1400 , (3, 0, None, None) , 0 , )),
	(( 'TopLevelTables' , 'prop' , ), 324, (324, (), [ (16393, 10, None, "IID('{0002094D-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 1408 , (3, 0, None, None) , 0 , )),
	(( 'Scripts' , 'prop' , ), 325, (325, (), [ (16393, 10, None, "IID('{000C0340-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 1416 , (3, 0, None, None) , 0 , )),
	(( 'CharacterWidth' , 'prop' , ), 326, (326, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1424 , (3, 0, None, None) , 0 , )),
	(( 'CharacterWidth' , 'prop' , ), 326, (326, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1432 , (3, 0, None, None) , 0 , )),
	(( 'Kana' , 'prop' , ), 327, (327, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1440 , (3, 0, None, None) , 0 , )),
	(( 'Kana' , 'prop' , ), 327, (327, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1448 , (3, 0, None, None) , 0 , )),
	(( 'BoldBi' , 'prop' , ), 400, (400, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1456 , (3, 0, None, None) , 0 , )),
	(( 'BoldBi' , 'prop' , ), 400, (400, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1464 , (3, 0, None, None) , 0 , )),
	(( 'ItalicBi' , 'prop' , ), 401, (401, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1472 , (3, 0, None, None) , 0 , )),
	(( 'ItalicBi' , 'prop' , ), 401, (401, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 1480 , (3, 0, None, None) , 0 , )),
	(( 'ID' , 'prop' , ), 405, (405, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 1488 , (3, 0, None, None) , 0 , )),
	(( 'ID' , 'prop' , ), 405, (405, (), [ (8, 1, None, None) , ], 1 , 4 , 4 , 0 , 1496 , (3, 0, None, None) , 0 , )),
	(( 'HTMLDivisions' , 'prop' , ), 406, (406, (), [ (16393, 10, None, "IID('{000209E8-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 1504 , (3, 0, None, None) , 0 , )),
	(( 'SmartTags' , 'prop' , ), 407, (407, (), [ (16393, 10, None, "IID('{000209EE-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 1512 , (3, 0, None, None) , 64 , )),
	(( 'ShowAll' , 'prop' , ), 408, (408, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 1520 , (3, 0, None, None) , 0 , )),
	(( 'ShowAll' , 'prop' , ), 408, (408, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 1528 , (3, 0, None, None) , 0 , )),
	(( 'Document' , 'prop' , ), 409, (409, (), [ (16397, 10, None, "IID('{00020906-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 1536 , (3, 0, None, None) , 0 , )),
	(( 'FootnoteOptions' , 'prop' , ), 410, (410, (), [ (16393, 10, None, "IID('{BEA85A24-D7DA-4F3D-B58C-ED90FB01D615}')") , ], 1 , 2 , 4 , 0 , 1544 , (3, 0, None, None) , 0 , )),
	(( 'EndnoteOptions' , 'prop' , ), 411, (411, (), [ (16393, 10, None, "IID('{BF043168-F4DE-4E7C-B206-741A8B3EF71A}')") , ], 1 , 2 , 4 , 0 , 1552 , (3, 0, None, None) , 0 , )),
	(( 'PasteAndFormat' , 'Type' , ), 412, (412, (), [ (3, 1, None, None) , ], 1 , 1 , 4 , 0 , 1560 , (3, 0, None, None) , 0 , )),
	(( 'PasteExcelTable' , 'LinkedToExcel' , 'WordFormatting' , 'RTF' , ), 413, (413, (), [ 
			 (11, 1, None, None) , (11, 1, None, None) , (11, 1, None, None) , ], 1 , 1 , 4 , 0 , 1568 , (3, 0, None, None) , 0 , )),
	(( 'PasteAppendTable' , ), 414, (414, (), [ ], 1 , 1 , 4 , 0 , 1576 , (3, 0, None, None) , 0 , )),
	(( 'XMLNodes' , 'prop' , ), 340, (340, (), [ (16393, 10, None, "IID('{D36C1F42-7044-4B9E-9CA3-85919454DB04}')") , ], 1 , 2 , 4 , 0 , 1584 , (3, 0, None, None) , 64 , )),
	(( 'XMLParentNode' , 'prop' , ), 341, (341, (), [ (16393, 10, None, "IID('{09760240-0B89-49F7-A79D-479F24723F56}')") , ], 1 , 2 , 4 , 0 , 1592 , (3, 0, None, None) , 64 , )),
	(( 'Editors' , 'prop' , ), 343, (343, (), [ (16393, 10, None, "IID('{AED7E08C-14F0-4F33-921D-4C5353137BF6}')") , ], 1 , 2 , 4 , 0 , 1600 , (3, 0, None, None) , 0 , )),
	(( 'XML' , 'DataOnly' , 'prop' , ), 344, (344, (), [ (11, 49, 'False', None) , 
			 (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 1608 , (3, 0, None, None) , 0 , )),
	(( 'XML' , 'DataOnly' , 'prop' , ), 344, (344, (), [ (11, 49, 'False', None) , 
			 (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 1608 , (3, 0, None, None) , 0 , )),
	(( 'EnhMetaFileBits' , 'prop' , ), 345, (345, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 1616 , (3, 0, None, None) , 0 , )),
	(( 'GoToEditableRange' , 'EditorID' , 'prop' , ), 415, (415, (), [ (16396, 17, None, None) , 
			 (16393, 10, None, "IID('{0002095E-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 1 , 1624 , (3, 0, None, None) , 0 , )),
	(( 'InsertXML' , 'XML' , 'Transform' , ), 416, (416, (), [ (8, 1, None, None) , 
			 (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 1632 , (3, 0, None, None) , 0 , )),
	(( 'InsertCaption' , 'Label' , 'Title' , 'TitleAutoText' , 'Position' , 
			 ...
			 (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 4 , 1640 , (3, 0, None, None) , 0 , )),
	(( 'InsertCrossReference' , 'ReferenceType' , 'ReferenceKind' , 'ReferenceItem' , 'InsertAsHyperlink' , 
			 ...
			 (16396, 17, None, None) , ], 1 , 1 , 4 , 4 , 1648 , (3, 0, None, None) , 0 , )),
	(( 'OMaths' , 'prop' , ), 346, (346, (), [ (16393, 10, None, "IID('{873E774B-926A-4CB1-878D-635A45187595}')") , ], 1 , 2 , 4 , 0 , 1656 , (3, 0, None, None) , 0 , )),
	(( 'CharacterStyle' , 'prop' , ), 420, (420, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 1664 , (3, 0, None, None) , 0 , )),
	(( 'ParagraphStyle' , 'prop' , ), 421, (421, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 1672 , (3, 0, None, None) , 0 , )),
	(( 'ListStyle' , 'prop' , ), 422, (422, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 1680 , (3, 0, None, None) , 0 , )),
	(( 'TableStyle' , 'prop' , ), 423, (423, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 1688 , (3, 0, None, None) , 0 , )),
	(( 'ContentControls' , 'prop' , ), 424, (424, (), [ (16393, 10, None, "IID('{804CD967-F83B-432D-9446-C61A45CFEFF0}')") , ], 1 , 2 , 4 , 0 , 1696 , (3, 0, None, None) , 0 , )),
	(( 'ExportFragment' , 'FileName' , 'Format' , ), 425, (425, (), [ (8, 1, None, None) , 
			 (3, 1, None, None) , ], 1 , 1 , 4 , 0 , 1704 , (3, 0, None, None) , 0 , )),
	(( 'WordOpenXML' , 'prop' , ), 426, (426, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 1712 , (3, 0, None, None) , 0 , )),
	(( 'SetListLevel' , 'Level' , ), 427, (427, (), [ (2, 1, None, None) , ], 1 , 1 , 4 , 0 , 1720 , (3, 0, None, None) , 0 , )),
	(( 'InsertAlignmentTab' , 'Alignment' , 'RelativeTo' , ), 500, (500, (), [ (3, 1, None, None) , 
			 (3, 49, '0', None) , ], 1 , 1 , 4 , 0 , 1728 , (3, 0, None, None) , 0 , )),
	(( 'ParentContentControl' , 'prop' , ), 501, (501, (), [ (16393, 10, None, "IID('{EE95AFE3-3026-4172-B078-0E79DAB5CC3D}')") , ], 1 , 2 , 4 , 0 , 1736 , (3, 0, None, None) , 0 , )),
	(( 'ImportFragment' , 'FileName' , 'MatchDestination' , ), 502, (502, (), [ (8, 1, None, None) , 
			 (11, 49, 'False', None) , ], 1 , 1 , 4 , 0 , 1744 , (3, 0, None, None) , 0 , )),
	(( 'ExportAsFixedFormat' , 'OutputFileName' , 'ExportFormat' , 'OpenAfterExport' , 'OptimizeFor' , 
			 ...
			 (11, 49, 'True', None) , (11, 49, 'False', None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 1752 , (3, 0, None, None) , 0 , )),
	(( 'Locks' , 'prop' , ), 504, (504, (), [ (16393, 10, None, "IID('{DFF99AC2-CD2A-43AD-91B1-A2BE40BC7146}')") , ], 1 , 2 , 4 , 0 , 1760 , (3, 0, None, None) , 0 , )),
	(( 'Updates' , 'prop' , ), 505, (505, (), [ (16393, 10, None, "IID('{30225CFC-5A71-4FE6-B527-90A52C54AE77}')") , ], 1 , 2 , 4 , 0 , 1768 , (3, 0, None, None) , 0 , )),
	(( 'Conflicts' , 'prop' , ), 506, (506, (), [ (16393, 10, None, "IID('{C2B83A65-B061-4469-83B6-8877437CB8A0}')") , ], 1 , 2 , 4 , 0 , 1776 , (3, 0, None, None) , 0 , )),
	(( 'TextVisibleOnScreen' , 'prop' , ), 507, (507, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 1784 , (3, 0, None, None) , 0 , )),
	(( 'SortByHeadings' , 'SortFieldType' , 'SortOrder' , 'CaseSensitive' , 'BidiSort' , 
			 'IgnoreThe' , 'IgnoreKashida' , 'IgnoreDiacritics' , 'IgnoreHe' , 'LanguageID' , 
			 ), 508, (508, (), [ (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , 
			 (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 9 , 1792 , (3, 0, None, None) , 0 , )),
	(( 'ExportAsFixedFormat2' , 'OutputFileName' , 'ExportFormat' , 'OpenAfterExport' , 'OptimizeFor' , 
			 ...
			 ), 509, (509, (), [ (8, 1, None, None) , (3, 1, None, None) , (11, 49, 'False', None) , (3, 49, '0', None) , 
			 (11, 49, 'False', None) , (3, 49, '0', None) , (11, 49, 'False', None) , (11, 49, 'True', None) , (3, 49, '0', None) , 
			 (11, 49, 'True', None) , (11, 49, 'True', None) , (11, 49, 'False', None) , (11, 49, 'False', None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 1800 , (3, 0, None, None) , 0 , )),
	(( 'ExportAsFixedFormat3' , 'OutputFileName' , 'ExportFormat' , 'OpenAfterExport' , 'OptimizeFor' , 
			 ...
			 'FixedFormatExtClassPtr' , ), 510, (510, (), [ (8, 1, None, None) , (3, 1, None, None) , (11, 49, 'False', None) , 
			 ...
			 (11, 49, 'False', None) , (16396, 17, None, None) , ], 1 , 1 , 4 , 1 , 1808 , (3, 0, None, None) , 0 , )),
]
